...
put(315, u"""    <div class="wire-lead">Farmers plant seeds. Some of those seeds have had genes added in a laboratory \u2014 usually taken from bacteria \u2014 so the crop survives being sprayed with weedkiller when a field full of weeds is sprayed, or makes its own insecticide in every leaf and root. These are examples of what\u2019s called Genetic Modification. Proponents argue that insect-resistant cotton substantially reduced broad-spectrum insecticide spraying in several countries \u2014 sprays that killed bees, birds and farm workers \u2014 and the claim that these foods are unsafe to eat has not held up in decades of testing. But, that isn’t the whole picture.<br><br>
